...
export const TENSION = {
  ...
  FAIL_THRESHOLD: 100,
  BASE_INCREASE: 0.06,
  STRETCH_INCREASE: 0.22,
  REST_DECREASE: 0.08,
  DANGLING_PENALTY: 0.32,
  BAD_POSTURE_PENALTY: 0.3,
  GRIP_BONUS: {
    4: -0.18,
    3: -0.05,
    2: 0.12,
...
export const DIFFICULTY = {
  EASY: {
    id: 'easy',
    name: '쉬움',
    holdCount: { min: 34, max: 42 },
    wallHeight: 820,
    tensionMultiplier: 0.8,
    topSpacing: { min: 72, max: 112 },
    zoneWeights: {
  ...
  NORMAL: {
    id: 'normal',
    name: '보통',
    holdCount: { min: 30, max: 38 },
    wallHeight: 1000,
    tensionMultiplier: 1.0,
    topSpacing: { min: 86, max: 134 },
    zoneWeights: {
  ...
  HARD: {
    id: 'hard',
    name: '어려움',
    holdCount: { min: 26, max: 34 },
    wallHeight: 1200,
    tensionMultiplier: 1.22,
    topSpacing: { min: 100, max: 160 },
    zoneWeights: {
